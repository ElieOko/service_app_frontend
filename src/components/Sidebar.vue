    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Service-App</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'article' ? activeClass : inactiveClass]"
          to="/article"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Article</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'dette' ? activeClass : inactiveClass]"
          to="/dette"
        >
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span class="mx-4">Dette</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'facturation' ? activeClass : inactiveClass]"
          to="/facturation"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Facturation</span>
        </router-link>
          <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'marketeur' ? activeClass : inactiveClass]"
          to="/marketeur"
        >
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <span class="mx-4">Marketeur Agent</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'stock' ? activeClass : inactiveClass]"
          to="/stock"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'taux' ? activeClass : inactiveClass]"
          to="/taux"
        >
          ...
          <span class="mx-4">Taux</span>
        </router-link>
        <router-link
            class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
            :class="[$route.name === 'versement' ? activeClass : inactiveClass]"
            to="/versement"
          >
            <svg
              class="w-5 h-5"

...
import { tableDeleteIcon, calendarIcon } from "@progress/kendo-svg-icons";
//@ts-ignore
...
<template>
    <button
         class = "text-white mt-5 bg-red-700 hover:bg-red-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:bg-red-800"
    > <svg 
    fill="#000000" 
    height="10px" 
    width="10px" 
    ...
    <g id="SVGRepo_iconCarrier"> <g id="XMLID_6_"> <g id="XMLID_11_"> 
